# Levis
## Kubernetes Manifest Generator (with node.js 14)
...
### Contents
- [Levis](#levis)
  - [Kubernetes Manifest Generator (with node.js 14)](#kubernetes-manifest-generator-with-nodejs-14)
    - [Contents](#contents)
...
|----------------|------------ |---------------------|----------------------|------------------|------------------|
| 1.0.14-alpha | 0.30.0 | 3.0.14 | 6.3.0 | 1.2.5 | 2.0.0-6 |
